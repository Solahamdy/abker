...
import '../../controller/controllers/controllers.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  void submitQuiz() async {
    ...
    if (allQuestionsAnswered) {
      ...
      var y = await saveTest(widget.quizQuestions, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMTkyLjE2OC4xLjk6NTAwMC9hcGkvbG9naW4iLCJpYXQiOjE3MTc4ODE1MzksImV4cCI6MTcxNzg4NTEzOSwibmJmIjoxNzE3ODgxNTM5LCJqdGkiOiJZRGpJNkk1ZE03UjFlVDdzIiwic3ViIjoiMiIsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.ZH7p7lcBepPzdQoXjiKyt9m9SQMkVpfsEmaBdvHl3SE');
      print(y.toString());
